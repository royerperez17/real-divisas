<?php
	...
	if(isset($_POST['correo']) && isset($_POST['contrasena'])){
		...
		$id=PersonaAdapter::verficarDatos($correo,$contrasena);
		if($id != 0){
		$persona=PersonaAdapter::perfilCliente($id);
		$_SESSION['cliente']=$persona;
		...
		$falloLogeo=true;
		session_destroy();
        // httptools::redireccionar('/pages/seguridad/error402.php');
...
<head>
    ...
    <link rel="stylesheet" text="text/css" href="/assets/css/login-persona.css">
